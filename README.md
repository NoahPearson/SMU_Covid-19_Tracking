...
### Data Last Updated: 10/2/2020 at 10:45 PM
...
Hopefully, SMU will also make positivity/number of tests, isolation capacity, among other data publicly accessible. Edit: on 9/3, the linked site also includes a "dashboard" with active cases and isolation capacity. There are currently **28**(-9) people quarantining on-campus (asked to quarantine in their rooms because they were contact-traced) and we are at **12%** isolation space capacity; there are **18**(-5) people isolating (because they have the virus) on-campus. The remaining active on-campus cases must be isolating at home.
...
![tot](https://github.com/NoahPearson/SMU_Covid-19_Tracking/blob/master/Plots/10:2_tot.png)

__New cases reported each day:__

With vertical lines marking the start of each week (Monday):

![new](https://github.com/NoahPearson/SMU_Covid-19_Tracking/blob/master/Plots/10:2_new.png)

__Weekly Average of Total New Cases Reported Each Day:__

![weekly](https://github.com/NoahPearson/SMU_Covid-19_Tracking/blob/master/Plots/10:2_weekly.png)

__3-Day moving average:__

![3day2](https://github.com/NoahPearson/SMU_Covid-19_Tracking/blob/master/Plots/10:2_mov3.png)
...
![7day](https://github.com/NoahPearson/SMU_Covid-19_Tracking/blob/master/Plots/10:2_mov7.png)

__10-Day moving average:__

![10day](https://github.com/NoahPearson/SMU_Covid-19_Tracking/blob/master/Plots/10:2_mov10.png)
...
![iso](https://github.com/NoahPearson/SMU_Covid-19_Tracking/blob/master/Plots/10:2_iso.png)
